...
(defvar plantuml-jar-path (expand-file-name "~/.emacs.d/personal/plantuml.8015.jar"))

(defvar plantuml-mode-hook nil "Standard hook for plantuml-mode.")

(defvar plantuml-mode-version nil "plantuml-mode version string.")

(defvar plantuml-run-command (concat "java -jar " (shell-quote-argument plantuml-jar-path) " -tsvg "))
...
(defun plantuml-display-image()
  ...
  (interactive)
  (let ((plantuml-file (concat (file-name-sans-extension buffer-file-name) ".svg")))
